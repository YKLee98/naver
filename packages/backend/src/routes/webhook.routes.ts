...
export function setupWebhookRoutes(services: ServiceContainer): Router {
    ...
    async (req, res, next) => {
      try {
        ...
        if (services.shopifyWebhookController) {
          await services.shopifyWebhookController.handleOrderCreate(req, res, next);
        } else {
  ...
  router.post('/shopify/orders/update',
    ...
    async (req, res, next) => {
      try {
        ...
        if (services.shopifyWebhookController) {
          await services.shopifyWebhookController.handleOrderUpdate(req, res, next);
        } else {
          res.status(200).send('OK');
        }
      } catch (error) {
  ...
  router.post('/shopify/orders/cancel',
    validateWebhookSignature('shopify'),
    async (req, res, next) => {
      try {
        ...
        if (services.shopifyWebhookController) {
          await services.shopifyWebhookController.handleOrderCancel(req, res, next);
        } else {
          res.status(200).send('OK');
        }
      } catch (error) {
  ...
  router.post('/shopify/products/create',
    ...
    async (req, res, next) => {
      try {
        ...
        if (services.shopifyWebhookController) {
          await services.shopifyWebhookController.handleProductCreate(req, res, next);
        } else {
          res.status(200).send('OK');
        }
      } catch (error) {
  ...
  router.post('/shopify/products/update',
    ...
    async (req, res, next) => {
      try {
        ...
        if (services.shopifyWebhookController) {
          await services.shopifyWebhookController.handleProductUpdate(req, res, next);
        } else {
          res.status(200).send('OK');
        }
      } catch (error) {
  ...
  router.post('/shopify/products/delete',
    ...
    async (req, res, next) => {
      try {
        ...
        if (services.shopifyWebhookController) {
          await services.shopifyWebhookController.handleProductDelete(req, res, next);
        } else {
          res.status(200).send('OK');
        }
      } catch (error) {
  ...
  router.post('/shopify/inventory_levels/update',
    ...
    async (req, res, next) => {
      try {
        ...
        if (services.shopifyWebhookController) {
          await services.shopifyWebhookController.handleInventoryUpdate(req, res, next);
        } else {
          res.status(200).send('OK');
        }
      } catch (error) {
